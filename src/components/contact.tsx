    ...
    <section className="mx-[30px] lg:mx-[76px] lg:mt-[150px]">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-[10px]">
          ...
          >
            {timeOfDay === "morning" && <span>{contactData.locations.morning}</span>}
            {timeOfDay === "afternoon" && <span>{contactData.locations.afternoon}</span>}
            {timeOfDay === "evening" && <span>{contactData.locations.evening}</span>}
          </p>
        </div>
      </div>
    </section>
